  ...
  describe "#to_csv" do
    it "returns a csv string with one row per attendee_plan" do
      ...
      expected = [
        ...
        [expected_user_id, a.user.email, expected_attendee_id, a.given_name, a.family_name, p1.name, expected_price_1, ap1.quantity.to_s],
        [expected_user_id, a.user.email, expected_attendee_id, a.given_name, a.family_name, p2.name, expected_price_2, "2"]
      ]
