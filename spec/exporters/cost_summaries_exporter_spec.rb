  ...
  describe "#to_csv" do
    it "returns a csv string with one row per attendee_plan" do
      ...
      expected = [
        ...
        [a.user.id.to_s, a.user.email, a.id.to_s, a.given_name, a.family_name, p1.name, expected_price_1, ap1.quantity.to_s],
        [a.user.id.to_s, a.user.email, a.id.to_s, a.given_name, a.family_name, p2.name, expected_price_2, "2"]
      ]
