...
ActiveRecord::Schema.define(version: 2022_03_31_023745) do
  ...
  create_table "activities", force: :cascade do |t|
    ...
    t.index ["id", "year"], name: "uniq_activities_on_id_and_year", unique: true
    t.index ["year", "leave_time"], name: "index_activities_on_year_and_start"
  end
  ...
  create_table "activity_categories", force: :cascade do |t|
    ...
    t.index ["id", "year"], name: "uniq_activity_categories_on_id_and_year", unique: true
  end
  ...
  create_table "attendee_activities", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.integer "year", null: false
    t.index ["activity_id"], name: "index_attendee_activities_on_activity_id"
    t.index ["attendee_id", "activity_id"], name: "uniq_attendee_activity", unique: true
  end
  ...
  create_table "attendee_plans", force: :cascade do |t|
    ...
    t.integer "year", null: false
    t.index ["attendee_id", "plan_id"], name: "uniq_attendee_plan", unique: true
  end

  create_table "attendee_tournaments", id: :serial, force: :cascade do |t|
    t.integer "attendee_id"
    t.integer "tournament_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "year"
    t.index ["attendee_id"], name: "index_attendee_tournaments_on_attendee_id"
    t.index ["tournament_id"], name: "index_attendee_tournaments_on_tournament_id"
  end
  ...
  create_table "bye_appointments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["attendee_id"], name: "index_bye_appointments_on_attendee_id"
    t.index ["round_id"], name: "index_bye_appointments_on_round_id"
  end
  ...
  create_table "editable_texts", id: :serial, force: :cascade do |t|
    t.integer "year"
    t.string "welcome"
    t.string "volunteers"
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.index ["id", "year"], name: "index_events_on_id_and_year", unique: true
  end
  ...
  create_table "game_appointments", force: :cascade do |t|
    ...
    t.string "result"
    t.integer "handicap"
    t.index ["attendee_one_id"], name: "index_game_appointments_on_attendee_one_id"
    t.index ["attendee_two_id"], name: "index_game_appointments_on_attendee_two_id"
    t.index ["round_id"], name: "index_game_appointments_on_round_id"
  end
  ...
  create_table "plan_categories", force: :cascade do |t|
    ...
    t.index ["id", "year"], name: "index_plan_categories_on_id_and_year", unique: true
  end
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.index ["id", "year"], name: "index_plans_on_id_and_year", unique: true
  ...
  create_table "shirts", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "disabled", default: false, null: false
    t.index ["hex_triplet", "year"], name: "index_shirts_on_hex_triplet_and_year", unique: true
    t.index ["id", "year"], name: "index_shirts_on_id_and_year", unique: true
    t.index ["name", "year"], name: "index_shirts_on_name_and_year", unique: true
  end
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.index ["year", "created_at"], name: "index_transactions_on_year_and_created_at"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["email", "year"], name: "index_users_on_email_and_year", unique: true
    t.index ["id", "year"], name: "index_users_on_id_and_year", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
    t.index ["year"], name: "index_users_on_year"
  end
